...
class ConversationSession(Base):
    ...
    target_vocabulary = Column(String, default="[]", nullable=False)  # JSON array stored as string
    vocabulary_used = Column(String, default="[]", nullable=False)  # JSON array stored as string
